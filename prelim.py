...
lsf.scp('/vpodrepo/2026-labs/2634/2634_mount_drives.sh', 'root@esx-05a:/scratch/2634_mount_drives.sh', "VMware123!VMware123!")
lsf.scp('/vpodrepo/2026-labs/2634/2634_mount_drives.sh', 'root@esx-06a:/scratch/2634_mount_drives.sh', "VMware123!VMware123!")
lsf.scp('/vpodrepo/2026-labs/2634/2634_mount_drives.sh', 'root@esx-07a:/scratch/2634_mount_drives.sh', "VMware123!VMware123!")
lsf.scp('/vpodrepo/2026-labs/2634/2634_mount_drives.sh', 'root@esx-08a:/scratch/2634_mount_drives.sh', "VMware123!VMware123!")
...
lsf.ssh('sh /scratch/2634_mount_drives.sh', 'root@esx-05a.site-a.vcf.lab', lsf.password)
lsf.ssh('sh /scratch/2634_mount_drives.sh', 'root@esx-06a.site-a.vcf.lab', lsf.password)
lsf.ssh('sh /scratch/2634_mount_drives.sh', 'root@esx-07a.site-a.vcf.lab', lsf.password)
lsf.ssh('sh /scratch/2634_mount_drives.sh', 'root@esx-08a.site-a.vcf.lab', lsf.password)
